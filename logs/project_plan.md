...
| Waseem  | Continue to build and evaluate CB model    |  -Finish CB model <br> - Evaluate the model using metrics like precision, recall, or F1-score. <br> - Suggest ways to combine it with collabrative filerting later |
